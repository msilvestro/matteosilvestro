...
Lately I've been focusing on writing arrangements for piano (which is the main
instrument I play) which I then publish on [MuseScore][ms]. Most of the times I
improve on already existing scores, but I made a few of them entirely by ear,
such as the cover of [High Without Your Love][hwyl].
